...
{
    /// <summary>
    ///  Represents a asynchronous base command that can be executed and optionally has a condition that determines 
    ///  if it can be executed.
    /// </summary>
    public class CommandBaseAsync : CommandBase
    {
        ...
        public CommandBaseAsync(Func<object, Task> executeAsync, Func<object, bool>? canExecute = null)
            : base(o => { }, canExecute)
        {
